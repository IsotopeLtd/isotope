...
part 'registrar_implementation.dart';
...
class WaitingTimeOutException implements Exception {
  ...
  String toString() {
    print(
        'Registar: There was a timeout while waiting for an instance to signal ready');
...
/// 
/// Retrieve the desired object using [get] or call your locator as function (it is a
/// callable class).
/// 
/// Additionally, Registrar offers asynchronous creation functions as well as functions to synchronize
/// the async initialization of multiple singletons.
abstract class Registrar {
  static Registrar _instance;

  /// Access to the singleton instance of Registrar
  static Registrar get instance {
    _instance ??= _RegistrarImplementation();
    return _instance;
  }

  /// If you need more than one instance of Registrar you can use [asNewInstance()].
  /// 
  /// You should prefer to use the `instance()` method to access the global instance of [Registrar].
  factory Registrar.asNewInstance() {
    return _RegistrarImplementation();
  }
  ...
  /// 
  /// For asynchronous factories you can pass up to 2 parameters `[param1, param2]` they have to match the types
  ...
  /// is registered inside Registrar.
  ...
  /// Select the lazy Singleton you want to reset by either providing
  ...
  /// the Singleton.
  /// If [instance] has a value Registrar will search for the responsible Singleton
