...
import 'package:isotope/src/widgets/note_text.dart';
...
class InputField extends StatefulWidget {
  ...
  final Decoration disabledFieldDecoration;
    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          ...
          decoration: widget.isReadOnly ? widget.disabledFieldDecoration : widget.fieldDecoration,
          child: Row(
            children: <Widget>[
              Expanded(
                child: TextFormField(
